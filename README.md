...
It gives an probable strategy to select stocks which has **higher alpha($\alpha$)**. Stocks with higher alpha often performance better than others. We use a simple random forest model to predict higher alpha stocks.
